# Generated by Django 4.2.16 on 2024-12-17 12:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link', models.URLField(blank=True, null=True, verbose_name='Task Link')),
                ('task_image', models.ImageField(blank=True, null=True, upload_to='task_images/', verbose_name='Task Image')),
                ('media_id', models.CharField(blank=True, max_length=100, null=True, verbose_name='Media ID')),
            ],
        ),
        migrations.CreateModel(
            name='Wallet',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('assigned', 'Assigned'), ('submitted', 'Submitted'), ('approved', 'Approved'), ('rejected', 'Rejected'), ('expired', 'Expired')], default='assigned', max_length=10, verbose_name='Assignment Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referred_user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='tracking', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Referral',
            fields=[
                ...
                ('referred_to', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='referral', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
